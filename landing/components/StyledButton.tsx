...
export const StyledButton = ({
  ...
  return waiting ? (
    ...
    <div className="relative z-0">
      <button
        onClick={onClick}
        className={`${wide ? "btn-wide" : ""} z-10 px-4 py-3 bg-[#E6FA04] active:bg-yellow-700 text-black text-lg rounded-[12px] border-2 border-black ${className} pixeloid-sans-bold text-base disabled:bg-[#7C8701] disabled:text-black-500`}
        disabled={disabled}
      >
        {children}
      </button>
