...
when it wasn't designed for such a role.`;
...
the next chess virtuoso!`;
  ...
  const a2 = `Virtuoso Club is currently deployed on Base L2. \
In other to play the game, you must connect to a funded crypto wallet. \
Virtuoso does cost anything to play (however Base L2 does take a small fee). \
  ...
  return (
    <div className="flex flex-col mt-10">
      ...
      <div className="mt-10">
        ...
        <div className={`max-w-[750px] text-sm opacity-60`}>{a2}</div>
      </div>
      <div className="mt-10">
