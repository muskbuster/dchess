  ...
  const cards = [
    {
      ...
      className: 'bg-pink-200 rounded-[16px] w-full sm:w-1/3 p-6 sm:p-12 flex items-center justify-center bg-gradient-to-r from-[#071226] to-[#393b2c]',
    },
    {
      title: 'a3_2_2',
      desc: `Mint NFTs to gain privileges and support creators`,
      className: 'bg-pink-200 rounded-[16px] w-full sm:w-1/3 p-6 sm:p-12 flex items-center justify-center bg-gradient-to-r from-[#3b3d27] to-[#3b3d27]',
    },
    {
      title: 'a3_2_3',
      desc: `Players can create puzzles and earn for their supporting the ecosystem`,
      className: 'bg-pink-200 rounded-[16px] w-full sm:w-1/3 p-6 sm:p-12 flex items-center justify-center bg-gradient-to-r from-[#393b2c] to-[#071226]',
    },
  ]
    ...
    <main className="px-3 sm:px-10">
      <div className="flex lg:flex-row md:flex-col flex-col justify-center items-center gap-y-8 py-10 sm:py-24">
        ...
        <div className="w-full lg:w-1/3 mr-0 flex flex-col items-center">
          <iframe
            className="md:w-[600px] md:h-[600px] w-[95vw] h-[95vw] rounded-lg overflow-hidden"
