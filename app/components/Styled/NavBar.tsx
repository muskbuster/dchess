    ...
    <div id="nav-links" className="gap-2 w-full">
      <StyledButtonSecondary
        className={`flex items-center w-full ${
          pathname.includes("play") || pathname == "/" ? activeStyle : ""
        }`}
      ...
      >
        <StyledButtonSecondary
          className={`flex items-center w-full ${
            pathname.includes("stats") ? activeStyle : ""
          }`}
        ...
        >
          <div className="w-full flex justify-center">            
            <svg
              className="h-5 pr-2"
              viewBox="0 0 20 21"
              fill={pathname.includes("stats") ? "#E6FA04" : "white"}
              xmlns="http://www.w3.org/2000/svg"
            >
      ...
      >
        <StyledButtonSecondary
          className={`flex items-center w-full ${
            pathname.includes("create") ? activeStyle : ""
          }`}
        ...
        >
          <div className="w-full flex justify-center">            
            <svg
              className="h-5 pr-2"
              viewBox="0 0 20 21"
              fill={pathname.includes("create") ? "#E6FA04" : "white"}
              xmlns="http://www.w3.org/2000/svg"
            >
