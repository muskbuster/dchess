...
/**
 * @notice The PWNED token
 * @custom:security-contact hi@asdf.codes
 */
contract PwnedToken is
    ERC20,
    ERC20Burnable,
    ERC20Pausable,
    ERC20Permit,
    ...
    Ownable
{
     ...
     */
    string public constant TOKEN_NAME = "Pwned";

    /**
     * @dev EIP-20 token symbol for this token
     */
    string public constant TOKEN_SYMBOL = "PWNED";
     ...
     */
    error PwnedMintCapExceeded();

    /**
     * @dev Construct a new Pwned token
